...
class APPL_TSNE(TrainerX):
    ...
    def TSNE(self):
        ...
        # cmap = get_cmap('viridis', num_labels)
        # cmap = get_cmap('tab20', max(num_labels, 20))  # 최소 20개 색상을 확보
        ...
        for i, label in enumerate(unique_labels):
            ...
            plt.title(f'epoch_{self.epoch+1} Meta_tokens - label')
            plt.legend()
            plt.savefig(f'{self.output_dir}/tsne_meta/{self.epoch+1}_meta_class.png')
