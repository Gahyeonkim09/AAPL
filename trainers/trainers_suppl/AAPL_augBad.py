...
class DiVE(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.augment_types = ['color_jitter_red', 'color_jitter_green', 'color_jitter_blue', 'vertical_flip', 'rotation_90', 'rotation_180', 'rotation_270']
